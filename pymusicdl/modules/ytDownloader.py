...
class yt_downloader:
    ...
    def download_singles(self):
        ...
        table.add_row(
            "flac",
            "usually >800kbps (1713kbps while testing, 5x of mp3)",
            "~39MB for 3min song",
    ...
    def download_playlist(self):
        ...
        try:
            ...
            print(
                f"Something went wrong. Maybe check your URL. Here's the reason from the compiler: {e}"
            )
                        ...
                        Panel(
                            "".join(
                                list(
                                    "".join(
                                        iz + "\n" * (N % 3 == 2)
                                        for N, iz in enumerate(
                                            [ii + " " for ii in user.split()]
                                        )
                                    )
                                )
                            )
